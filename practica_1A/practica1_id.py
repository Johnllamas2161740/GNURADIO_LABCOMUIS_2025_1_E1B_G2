...
class practica1_id(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "practica1_title", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("practica1_title")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "practica1_id")
        ...
        self._frequency_range = qtgui.Range(0, 10000, 100, 1000, 200)
        self._frequency_win = qtgui.RangeWidget(self._frequency_range, self.set_frequency, "Frequency in Hz", "slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=practica1_id, options=None):
